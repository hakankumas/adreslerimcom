...
<body>
  ...
  <section id="hero" class="d-flex align-items-center">
    <div class="container text-center position-relative" data-aos="fade-in" data-aos-delay="200">
      ...
      <div class="col-5" style="display: flex; margin:auto;">
        <form action="user/search.php" method="GET" class="input-group rounded">
          
          <div class="input-group mb-3">
            <div class="input-group-lg">
              <span class="input-group-text" id="basic-addon1">adreslerim.com/@</span>
            </div>
            <input type="text" name="user_username" class="form-control form-control-lg" placeholder="username" aria-label="Username" aria-describedby="basic-addon1" autofocus required>
          </div>

          <div class="input-group mt-3 justify-content-center">
            <button type="submit" name="searchUser" class="btn btn-lg btn-primary">Ara</button>
          </div>
